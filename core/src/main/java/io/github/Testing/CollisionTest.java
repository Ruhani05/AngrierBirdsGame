...
public class CollisionTest {
    @Test
    public void testBirdAndBlockCollision() {
        // Setup

        World world = new World(new Vector2(0, -9.8f), true); // Gravity vector


        Bird bird = new Bird("bird1.PNG", 0.216f, 0.355f, 45, 45,world,1);
